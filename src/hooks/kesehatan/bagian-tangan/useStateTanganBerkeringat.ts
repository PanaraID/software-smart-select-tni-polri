...
function useStateTanganBerkeringat(): [
  YES_OR_NO | undefined,
  React.Dispatch<React.SetStateAction<YES_OR_NO | undefined>>
] {
  return useState<YES_OR_NO | undefined>(() => {
    const storedPage = localStorage.getItem(LOCAL_STORAGE_KEY.TANGAN_TELAPAK_TANGAN_BERKERINGAT);
...
export default useStateTanganBerkeringat;

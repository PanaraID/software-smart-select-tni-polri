...
function useStateKakiPesKavus(): [
  YES_OR_NO | undefined,
  React.Dispatch<React.SetStateAction<YES_OR_NO | undefined>>
] {
  return useState<YES_OR_NO | undefined>(() => {
    const storedPage = localStorage.getItem(LOCAL_STORAGE_KEY.KAKI_TELAPAK_KAKU_PES_KAVUS_BERBENTUK_CAKAR);
...
export default useStateKakiPesKavus;

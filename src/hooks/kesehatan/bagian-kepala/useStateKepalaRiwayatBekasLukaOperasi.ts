...
function useStateKepalaRiwayatBekasLukaOperasi(): [
  YES_OR_NO | undefined,
  React.Dispatch<React.SetStateAction<YES_OR_NO | undefined>>
] {
  return useState<YES_OR_NO | undefined>(() => {
    const storedPage = localStorage.getItem(LOCAL_STORAGE_KEY.KEPALA_RIWAYAT_BEKAS_LUKA_OPERASI);
...
export default useStateKepalaRiwayatBekasLukaOperasi;
